...
* [Thymeleaf](https://docs.spring.io/spring-boot/docs/3.0.0-RC2/reference/htmlsingle/#web.servlet.spring-mvc.template-engines)
* [Validation](https://docs.spring.io/spring-boot/docs/3.0.0-RC2/reference/htmlsingle/#io.validation)
